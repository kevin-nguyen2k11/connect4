...
std::tuple<Array<int, nanobind::any, 2>, Array<float, nanobind::any, Config::width>, int> Self_player::play_game()
{
...
std::tuple<int, int> evaluate(const std::string& best_directory, const std::string& latest_directory)
{
    int wins{0};
    int draws{0};

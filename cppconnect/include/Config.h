...
namespace Config
{
    ...
    //Self play
    inline constexpr int num_high_temp_moves{20};
    inline constexpr int num_simulations{400};
...
//    inline constexpr std::string_view buffer_directory{"/Users/kevinnguyen/Documents/Python files/connect_4/data"};
    ...
    //UCB formula
    inline constexpr float c_base{5};
    inline constexpr float c_init{1.25};

    //Evaluation
    inline constexpr int num_eval_games{100};
    inline constexpr int num_eval_threads{2};
//    inline constexpr float win_margin{0.55};
